                ...
                <form class="needs-validation mb-3 mt-5" id="registerForm" action='' novalidate>
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3 reg-input-margin-right">
                            ...
                            <input type="password" class="form-control" id="password" name="password" value="Otto"
                                required>
                            <div class="valid-tooltip">
                                Looks good!
                            </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3 reg-input-margin-left">
                            ...
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="customCheck1">By selecting 'Checkbox', you
                                    agree to our <a href="#" class="link">terms and conditions</a> .</label>
