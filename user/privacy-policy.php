...
<main class="pivacy-policy-page mb-5">
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <article class="mt-3">
                <p>PostMailExpress, an operating unit of The Education Partnership (TEP) Centre Ltd (hereinafter referred to as “PME”) is pleased that you visited our website and are interested in our company, products and services.</p>

                <p>
                This Privacy Policy governs the manner in which PME collects, uses, maintains and discloses information collected from users (each, a "User") of the www.postmailexpress.com website ("Site"). This privacy policy applies to the Site and all products and services offered by PME.
                </p>
            </article>
                <article>
                ...
                <article>
                    ...
                    <dl>
                        ...
                        <dd>We may use the information Users provide about themselves when placing an order only to provide service to that order. We do not share this information with third parties except to the extent necessary to provide the service.</dd>

                        <dt>- To send periodic emails</dt>
                        <dd>We may use the email address to respond to their inquiries, questions, and/or other requests.</dd>
                    </dl>
                ...
                <article>
                    ...
                    <p>PME has the discretion to update this privacy policy at any time. When we do, we will revise the updated date at the bottom of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.
                    </p>
                </article>
