  ...
  <div class="row">
    <div class="col col-lg-6 offset-lg-3 col-md-6 offset-md-3">
      <form class="needs-validation mb-3 mt-5" action='' novalidate>
        ...
        <div class="form-row">
          <div class="col mb-3">
            <label for="validationTooltip01">Email Address or User ID</label>
            <input type="text" class="form-control" id="validationTooltip01" value="iballi2017@gmail.com" required>
        ...
        <div class="form-row">
          <div class="col mb-3">
            ...
            <input type="password" class="form-control" id="validationTooltip01" value="Mark" required>
            <div class="valid-tooltip">
              Looks good!
            </div>
          </div>
